<nav class="navbar navbar-expand-lg bg-body-tertiary ">
        <div class="container-fluid">
            <a class="navbar-brand" href="/50Projects/Base/baseIndex.php"><img  src="./baseMedia/no-brain-loading.gif" alt="" srcset=""
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./baseindex.php">Home</a>
                    </li>
